...
def label_batch(input_folder, output_folder, criteria, model, max_token_limit):
...
if __name__ == "__main__":
    ...
    input_folder = config['raw_transcripts_gen']['output_folder']
    output_folder = config['gpt_data_label']['generated_label_output_folder']
    ...
    label_batch(input_folder, output_folder, criteria, model, max_token_limit)